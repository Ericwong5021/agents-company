...
7. [Founder OS v1 当前合同](product-design/Founder-OS-v1.md)：已实现的创始人代理、Founder Assets、Company Commons 与 Learning Loop；开发任务明细保留在[完成计划](AgentCompany-Founder-OS-Development-Plan-v1.0.md)。
...
- 问“动态组织和任务图何时可用”→ 看 Seed-and-Grow 的实施波次与精确提交 Gate。
- 问“创始人代理、公司认知和组织学习现在如何工作”→ 看 Founder OS v1 当前合同；机器开发完成不等于提高运行模式或取得人工授权。
- 问“哪些人工研究和真实样本仍未确认”→ 看 Pre-Public 弱门禁登记。
- 这些文档对同一能力给出不同状态时，以代码事实为准，并在同一次变更中修正过时的一侧。
...
| [Founder-OS-v1.md](product-design/Founder-OS-v1.md) | Founder OS 当前实现、模式、页面、代码与验证边界 | 产品开发完成 / 模式默认关闭 |
| [AgentCompany-Founder-OS-Development-Plan-v1.0.md](AgentCompany-Founder-OS-Development-Plan-v1.0.md) | W0–W7、E0、K0–K2 任务与 Gate 合同 | 已完成 / 机器证据通过 |
| [ADR-Founder-OS-Governance-v1.0.md](product-design/ADR-Founder-OS-Governance-v1.0.md) | Founder Twin 治理、权限、来源、Ledger 与身份边界 | Implemented / 人工确认未完成 |
| [Founder-OS-IA-v1.0.md](product-design/Founder-OS-IA-v1.0.md) | Founder OS 页面在现有五项一级导航中的归属 | Implemented / Frozen |
| [pre-public-acceptance-register.md](product-design/pre-public-acceptance-register.md) | 人工研究、主观验收与真实样本 | 开放 / 非阻塞 |
...
- [Marvis 视觉设计源](design/README.md)：记录 Pencil 目标稿与设计参照；它是实现参考，不覆盖产品宪法或 PRD。
...
- 已完成的临时计划、故障报告和验证快照由 Git 历史追溯，不在现行文档树长期保留；机器 Gate 仍绑定的任务合同除外。
- 人工与真实样本验收统一登记在 Pre-Public 弱门禁登记；被替换实现的历史 QA 不保留在现行文档树。
