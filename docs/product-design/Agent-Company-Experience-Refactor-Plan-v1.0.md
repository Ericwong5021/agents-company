...
截至 2026-07-28，R0 技术候选固定为 `17b3d80e418d73437c61b887528789196f39c360`，已完成以下自动验收：

| 自动验收 | 当前结果 |
|---|---|
| 基准场景 | 12 个场景各重复执行 2 次，归一化摘要一致，`reproducible: true` |
| exact-build 自动证据 | 18 条命令全部通过，覆盖 13 个 R0 Task、39 条验收标准；证据包 SHA-256 为 `3bd265a18724f38a4e822b398e08d976bc936f230af282f449f4a6ed38e60074` |
