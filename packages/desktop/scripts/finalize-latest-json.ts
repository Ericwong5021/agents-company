...
const releaseId = process.env.AGENTCOMPANY_RELEASE
if (!releaseId) throw new Error("AGENTCOMPANY_RELEASE is required")

const version = process.env.AGENTCOMPANY_VERSION
if (!version) throw new Error("AGENTCOMPANY_VERSION is required")
...
const macxTarGz = "control-plane-desktop-mac-x64.app.tar.gz"
const macaTarGz = "control-plane-desktop-mac-arm64.app.tar.gz"
