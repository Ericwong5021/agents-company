export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Agent Company",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Agent Company، هل ترغب في تثبيته وإعادة تشغيله؟",
