export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Agent Company を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Agent Company のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'agents' コマンドを使用してください。",
