export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Agent Company",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Agent Company foi baixada. Você gostaria de instalá-la e reiniciar?",
