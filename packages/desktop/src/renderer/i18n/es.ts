export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Agent Company",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Agent Company. ¿Quieres instalarla y reiniciar?",
