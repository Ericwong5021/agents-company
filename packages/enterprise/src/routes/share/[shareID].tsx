import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@agents-company/sdk/v2"
import { SessionTurn } from "@agents-company/ui/session-turn"
import { SessionReview } from "@agents-company/ui/session-review"
import { DataProvider } from "@agents-company/ui/context"
import { FileComponentProvider } from "@agents-company/ui/context/file"
import { WorkerPoolProvider } from "@agents-company/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@agents-company/ui/logo"
import { IconButton } from "@agents-company/ui/icon-button"
import { ProviderIcon } from "@agents-company/ui/provider-icon"
import { iife } from "@agents-company/shared/util/iife"
...
import { MessageNav } from "@agents-company/ui/message-nav"
import { FileSSR } from "@agents-company/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@agents-company/ui/pierre/worker").then((m) => ({
