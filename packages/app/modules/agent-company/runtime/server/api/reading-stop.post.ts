...
import type { ReadingAssignmentRecord } from "@agents-company/sdk/v2"
...
export default defineAgentCompanyHandler(async (event): Promise<ReadingAssignmentRecord> => {
  ...
  const result = await requestControlPlaneSDK<ReadingAssignmentRecord>(
