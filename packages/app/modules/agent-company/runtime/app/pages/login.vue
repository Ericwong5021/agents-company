...
const baseURL = typeof window === "undefined" ? process.env.BETTER_AUTH_URL || "http://localhost:3000" : undefined
const authClient = createAuthClient(baseURL ? { baseURL } : undefined)
