...
beforeAll(async () => {
  ...
  mock.module("@agents-company/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@agents-company/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@agents-company/ui/icon", () => ({ Icon: () => null }))
  mock.module("@agents-company/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
