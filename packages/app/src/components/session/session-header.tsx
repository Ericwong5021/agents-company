import { AppIcon } from "@agents-company/ui/app-icon"
import { Button } from "@agents-company/ui/button"
import { DropdownMenu } from "@agents-company/ui/dropdown-menu"
import { Icon } from "@agents-company/ui/icon"
import { IconButton } from "@agents-company/ui/icon-button"
import { Keybind } from "@agents-company/ui/keybind"
import { Spinner } from "@agents-company/ui/spinner"
import { showToast } from "@agents-company/ui/toast"
import { Tooltip, TooltipKeybind } from "@agents-company/ui/tooltip"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_AGENTCOMPANY_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("control-plane-titlebar-center"))
    setRightMount(document.getElementById("control-plane-titlebar-right"))
  })
