export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.controlPlane.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.controlPlaneGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Visite ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins configurados em agent-company.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Agent Company este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Agent Company ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Agent Company",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (agent-company.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Agent Company ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Agent Company dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Agent Company",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Agent Company aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Agent Company segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Agent Company é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Agent Company iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Agent Company.",
  ...
  "company.pairing.title": "Emparelhar este navegador",
  "company.pairing.description": "Insira um código de emparelhamento de curta duração do seu servidor local Agent Company.",
  "company.pairing.code.label": "Código de emparelhamento",
  "company.pairing.label.label": "Nome do navegador",
  "company.pairing.submit": "Conectar com segurança",
  "company.pairing.pending": "Conectando…",
  "company.pairing.invalid": "O código de emparelhamento é inválido ou expirou.",
}
