export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.controlPlane.tagline": "Modelos optimizados y fiables",
  "dialog.provider.controlPlaneGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.controlPlaneZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.controlPlaneZen.visit.prefix": "Visita ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins configurados en agent-company.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Agent Company se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Agent Company ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Agent Company",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (agent-company.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Agent Company no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Agent Company dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Agent Company",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Agent Company en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Agent Company sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Agent Company.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Agent Company",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Agent Company.",
  ...
  "company.pairing.title": "Vincular este navegador",
  "company.pairing.description": "Introduce un código de vinculación de corta duración de tu servidor local de Agent Company.",
  "company.pairing.code.label": "Código de vinculación",
  "company.pairing.label.label": "Nombre del navegador",
  "company.pairing.submit": "Conectar de forma segura",
  "company.pairing.pending": "Conectando…",
  "company.pairing.invalid": "El código de vinculación no es válido o ha caducado.",
}
