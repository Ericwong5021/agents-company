...
export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.controlPlane.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.controlPlaneGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Agent Company zu nutzen.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Agent Company zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Agent Company zu nutzen.",
  ...
  "dialog.plugins.empty": "In agent-company.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Agent Company-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Agent Company ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Agent Company-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (agent-company.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Agent Company unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Agent Company-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Agent Company ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Agent Company auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Agent Company dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Agent Company anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Agent Company automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Agent Company.",
  ...
  "company.pairing.title": "Diesen Browser koppeln",
  "company.pairing.description": "Gib einen kurzlebigen Kopplungscode von deinem lokalen Agent Company-Server ein.",
  "company.pairing.code.label": "Kopplungscode",
  "company.pairing.label.label": "Browsername",
  "company.pairing.submit": "Sicher verbinden",
  "company.pairing.pending": "Verbindung wird hergestellt…",
  "company.pairing.invalid": "Der Kopplungscode ist ungültig oder abgelaufen.",
