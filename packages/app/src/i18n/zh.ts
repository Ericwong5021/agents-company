...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 curated provider 或 API 密钥连接",
  ...
  "provider.connect.opencodeZen.line1": "curated provider 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.opencodeZen.visit.link": "local setup",
