...
export const dict = {
  ...
  "dialog.provider.controlPlane.note": "使用 curated provider 或 API 密钥连接",
  "dialog.provider.controlPlane.tagline": "可靠的优化模型",
  "dialog.provider.controlPlaneGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Agent Company 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Agent Company 中使用 {{provider}} 模型。",
  ...
  "provider.connect.controlPlaneZen.line1": "curated provider 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.controlPlaneZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.controlPlaneZen.visit.prefix": "访问 ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix":
    " 获取授权码，以连接你的帐户并在 Agent Company 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 Agent Company 中使用 {{provider}} 模型。",
  ...
  "provider.custom.field.format.label": "API 兼容格式",
  "provider.custom.field.format.openai": "OpenAI 兼容",
  "provider.custom.field.format.anthropic": "Anthropic 兼容",
  ...
  "provider.custom.models.fetch": "拉取模型列表",
  "provider.custom.models.fetching": "正在拉取…",
  "provider.custom.models.empty": "该提供商没有返回可用模型",
  "provider.custom.models.fetchFailed": "无法拉取模型列表",
  ...
  "dialog.plugins.empty": "在 agent-company.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Agent Company 服务器。",
  ...
  "toast.update.description": "Agent Company 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Agent Company 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (agent-company.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Agent Company 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Agent Company 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，如 Claude、GPT、Gemini 等。",
  "sidebar.project.recentSessions": "最近会话",
  "sidebar.project.viewAllSessions": "查看全部会话",
  "sidebar.project.clearNotifications": "清除通知",

  "app.name.desktop": "Agent Company Desktop",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Agent Company 服务器。",
  ...
  "settings.general.row.language.description": "更改 Agent Company 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Agent Company 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Agent Company 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Agent Company 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Agent Company 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Agent Company。",
  ...
  "settings.providers.defaultModel.title": "全局默认模型",
  "settings.providers.defaultModel.description": "用于新建对话和未指定模型的智能体。",
  "settings.providers.defaultModel.label": "默认模型",
  "settings.providers.defaultModel.placeholder": "请选择模型",
  "settings.providers.defaultModel.saved.title": "已更新全局默认模型",
  "settings.providers.defaultModel.saved.description": "将使用 {{model}}。",
  ...
  "company.pairing.title": "配对此浏览器",
  "company.pairing.description": "请输入本地 Agent Company 服务器提供的短时配对码。",
  "company.pairing.code.label": "配对码",
  "company.pairing.label.label": "浏览器名称",
  "company.pairing.submit": "安全连接",
  "company.pairing.pending": "正在连接…",
  "company.pairing.invalid": "配对码无效或已过期。",
  "company.bootstrap.title": "初始化本地 Company",
  "company.bootstrap.subtitle": "为这个单用户本地工作区选择模型提供商、仓库与初始运行策略。",
  "company.bootstrap.progress": "第 {{current}} 步，共 {{total}} 步",
  "company.bootstrap.steps.label": "Company 初始化步骤",
  "company.bootstrap.step.provider": "提供商",
  "company.bootstrap.step.company": "公司",
  "company.bootstrap.step.repository": "仓库",
  "company.bootstrap.step.policy": "策略",
  "company.bootstrap.step.review": "确认",
  "company.bootstrap.provider.label": "模型提供商",
  "company.bootstrap.provider.placeholder": "选择提供商",
  "company.bootstrap.provider.connect": "创建 Company 前需要连接此提供商。",
  "company.bootstrap.provider.apiKey": "API 密钥",
  "company.bootstrap.provider.connectAction": "连接",
  "company.bootstrap.provider.oauthCode": "授权码",
  "company.bootstrap.provider.confirmOAuth": "确认授权",
  "company.bootstrap.provider.custom.title": "自定义提供商",
  "company.bootstrap.provider.custom.description": "使用兼容 OpenAI 或 Anthropic 的自定义端点与 API 密钥。",
  "company.bootstrap.provider.custom.action": "添加自定义提供商",
  "company.bootstrap.model.label": "模型",
  "company.bootstrap.model.placeholder": "选择模型",
  "company.bootstrap.company.name": "公司名称",
  "company.bootstrap.company.dataDirectory": "本地数据目录",
  "company.bootstrap.repository.path": "仓库路径",
  "company.bootstrap.repository.placeholder": "/绝对路径/到/仓库",
  "company.bootstrap.repository.pick": "选择文件夹",
  "company.bootstrap.repository.inspect": "检查仓库",
  "company.bootstrap.repository.dirty": "工作区有未提交改动",
  "company.bootstrap.repository.clean": "工作区干净",
  "company.bootstrap.policy.title": "审批策略",
  "company.bootstrap.policy.autonomous.title": "自主",
  "company.bootstrap.policy.autonomous.body": "以最少人工干预推进常规工作。",
  "company.bootstrap.policy.balanced.title": "平衡",
  "company.bootstrap.policy.balanced.body": "重要变更需要审查，同时保持常规工作流畅推进。",
  "company.bootstrap.policy.strict.title": "严格",
  "company.bootstrap.policy.strict.body": "工作推进前都需要显式审查。",
  "company.bootstrap.review.company": "公司",
  "company.bootstrap.review.provider": "提供商与模型",
  "company.bootstrap.review.repository": "仓库",
  "company.bootstrap.review.policy": "审批策略",
  "company.bootstrap.back": "返回",
  "company.bootstrap.next": "继续",
  "company.bootstrap.creating": "正在创建…",
  "company.bootstrap.create": "创建 Company",
  "company.bootstrap.error.load": "无法加载提供商。请确认本地 Control Plane 正在运行后重试。",
  "company.bootstrap.error.provider": "无法连接此提供商，草稿已保留。",
  "company.bootstrap.error.repository": "无法检查此仓库。请确认它是 Git 仓库后重试。",
  "company.bootstrap.error.initialized": "这里已存在一个 Company。请先检查现有本地公司再继续。",
  "company.bootstrap.error.submit": "无法创建 Company，草稿已保留以便重试。",

  "company.ready.subtitle": "本地 Control Plane 已为此仓库完成配置。",
  "company.ready.status": "已就绪",
  "company.ready.facts": "Company 配置",
  "company.ready.dataDirectory": "本地数据目录",
  "company.ready.provider": "提供商与模型",
  "company.ready.repository": "仓库",
  "company.ready.policy": "审批策略",
  "company.ready.dirty": "初始化时工作区有改动",
  "company.ready.clean": "初始化时工作区干净",
  "company.ready.board.eyebrow": "初始董事会",
  "company.ready.board.title": "三个负责角色",
  "company.ready.start.eyebrow": "下一步",
  "company.ready.start.bootstrap_complete.title": "Company 初始化完成",
  "company.ready.start.m2": "M2 提供",
  "company.ready.start.action": "打开董事会",
  "company.ready.capability.title": "董事会消息尚未启用",
  "company.ready.capability.body": "M1 先建立本地 Company 契约，消息能力计划在 M2 提供。",
  "company.ready.credentials.eyebrow": "本地访问",
  "company.ready.credentials.title": "浏览器凭据",
  "company.ready.credentials.pending": "正在准备…",
  "company.ready.credentials.pair": "连接浏览器",
  "company.ready.credentials.paired": "此浏览器已配对。浏览器凭据管理需要受信任的本地会话。",
  "company.ready.credentials.revoked": "已撤销",
  "company.ready.credentials.revoke": "撤销",
  "company.ready.credentials.empty": "尚未配对浏览器。",
  "company.ready.credentials.error": "无法更新浏览器凭据，请重试。",
  "company.ready.start.bootstrap_complete.body": "在下方董事会频道发送目标，董事会将讨论并把结论与风险投影回主会话。",
  "company.sidebar.label": "频道",
  "company.sidebar.title": "频道",
  "company.sidebar.loading": "加载中…",
  "company.sidebar.empty": "暂无频道",
  "company.sidebar.group.company": "公司",
  "company.sidebar.group.board": "董事会",
  "company.sidebar.group.project": "项目",
  "company.feed.loading": "正在加载消息…",
  "company.feed.empty.title": "还没有消息",
  "company.feed.empty.body": "在下方发送一个目标，开始董事会讨论。",
  "company.feed.loadMore": "加载更早的消息",
  "company.feed.you": "你",
  "company.feed.sending": "发送中…",
  "company.feed.dri": "负责人",
  "company.feed.openThread": "查看来源 Thread",
  "company.signal.conclusion": "结论",
  "company.signal.status": "状态",
  "company.signal.risk": "风险",
  "company.signal.intervention": "中断",
  "company.signal.decision": "决定",
  "company.signal.plan": "计划",
  "company.signal.approval": "批准",
  "company.signal.delivery": "交付",
  "company.thread.label": "Thread",
  "company.thread.close": "关闭 Thread",
  "company.thread.members": "参与者",
  "company.thread.interrupt": "中断",
  "company.thread.loadMore": "加载更早的条目",
  "company.thread.empty": "该 Thread 暂无条目。",
  "company.thread.status.active": "进行中",
  "company.thread.status.completed": "已完成",
  "company.thread.status.interrupted": "已中断",
  "company.thread.run.queued": "等待运行",
  "company.thread.run.running": "Board 讨论中",
  "company.thread.run.projecting": "正在生成有依据的结果",
  "company.thread.run.completed": "运行已完成",
  "company.thread.run.failed": "运行失败，可重试",
  "company.thread.run.interrupted": "运行已中断",
  "company.thread.source.open": "查看证据",
  "company.composer.label": "发送消息",
  "company.composer.placeholder": "向董事会发送目标…",
  "company.composer.send": "发送",
  "company.composer.sending": "发送中…",
  "company.composer.retry": "重试",
  "company.composer.interrupt": "中断当前 Thread",
  "company.composer.mention.label": "提及董事角色",
