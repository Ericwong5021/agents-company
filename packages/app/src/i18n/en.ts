export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.controlPlane.tagline": "Reliable optimized models",
  "dialog.provider.controlPlaneGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Agent Company.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.controlPlaneZen.line1":
    "curated provider gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.controlPlaneZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.controlPlaneZen.visit.prefix": "Visit ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins configured in agent-company.json",
  ...
  "dialog.server.description": "Switch which Agent Company server this app connects to.",
  ...
  "toast.update.description": "A new version of Agent Company ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Agent Company team",
  ...
  "error.chain.checkConfig": "Check your config (agent-company.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Agent Company does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Agent Company server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Agent Company",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Agent Company launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Agent Company.",
  ...
  "settings.providers.defaultModel.title": "Global default model",
  "settings.providers.defaultModel.description": "Used for new conversations and agents without an explicit model.",
  "settings.providers.defaultModel.label": "Default model",
  "settings.providers.defaultModel.placeholder": "Select a model",
  "settings.providers.defaultModel.saved.title": "Global default model updated",
  "settings.providers.defaultModel.saved.description": "{{model}} will be used.",
  ...
  "company.pairing.title": "Pair this browser",
  "company.pairing.description": "Enter a short-lived pairing code from your local Agent Company server.",
  "company.pairing.code.label": "Pairing code",
  "company.pairing.label.label": "Browser name",
  "company.pairing.submit": "Connect securely",
  "company.pairing.pending": "Connecting…",
  ...
  "company.bootstrap.step.company": "Company",
  "company.bootstrap.step.repository": "Repository",
  "company.bootstrap.step.policy": "Policy",
  "company.bootstrap.step.review": "Review",
  "company.bootstrap.provider.label": "Provider",
  "company.bootstrap.provider.placeholder": "Choose a provider",
  "company.bootstrap.provider.connect": "Connect this provider before creating the company.",
  "company.bootstrap.provider.apiKey": "API key",
  ...
  "company.bootstrap.company.dataDirectory": "Local data directory",
  "company.bootstrap.repository.path": "Repository path",
  "company.bootstrap.repository.placeholder": "/absolute/path/to/repository",
  "company.bootstrap.repository.pick": "Choose folder",
  "company.bootstrap.repository.inspect": "Inspect repository",
  "company.bootstrap.repository.dirty": "Working tree has changes",
  "company.bootstrap.repository.clean": "Working tree is clean",
  "company.bootstrap.policy.title": "Approval policy",
  ...
  "company.bootstrap.review.provider": "Provider and model",
  "company.bootstrap.review.repository": "Repository",
  "company.bootstrap.review.policy": "Approval policy",
  "company.bootstrap.back": "Back",
  "company.bootstrap.next": "Continue",
  "company.bootstrap.creating": "Creating…",
  ...
  "company.ready.status": "Ready",
  "company.ready.facts": "Company configuration",
  "company.ready.dataDirectory": "Local data directory",
  "company.ready.provider": "Provider and model",
  "company.ready.repository": "Repository",
  "company.ready.policy": "Approval policy",
  "company.ready.dirty": "Working tree had changes at bootstrap",
  "company.ready.clean": "Working tree was clean at bootstrap",
  "company.ready.board.eyebrow": "Initial board",
  "company.ready.board.title": "Three accountable roles",
  "company.ready.start.eyebrow": "Next step",
  "company.ready.start.bootstrap_complete.title": "Company setup is complete",
  "company.ready.start.bootstrap_complete.body": "Send a goal in the board channel below; the board discusses it and projects conclusions and risks back to the main channel.",
  ...
  "company.ready.credentials.error": "Unable to update browser credentials. Try again.",
  "company.sidebar.label": "Channels",
  "company.sidebar.title": "Channels",
  "company.sidebar.loading": "Loading…",
  "company.sidebar.empty": "No channels",
  "company.sidebar.group.company": "Company",
  "company.sidebar.group.board": "Board",
  "company.sidebar.group.project": "Projects",
  "company.feed.loading": "Loading messages…",
  "company.feed.empty.title": "No messages yet",
  "company.feed.empty.body": "Send a goal below to start the board discussion.",
  "company.feed.loadMore": "Load earlier messages",
  "company.feed.you": "You",
  "company.feed.sending": "Sending…",
  "company.feed.dri": "DRI",
  "company.feed.openThread": "View source thread",
  "company.signal.conclusion": "Conclusion",
  "company.signal.status": "Status",
  "company.signal.risk": "Risk",
  "company.signal.intervention": "Intervention",
  "company.signal.decision": "Decision",
  "company.signal.plan": "Plan",
  "company.signal.approval": "Approval",
  "company.signal.delivery": "Delivery",
  "company.thread.label": "Thread",
  "company.thread.close": "Close thread",
  "company.thread.members": "Participants",
  "company.thread.interrupt": "Interrupt",
  "company.thread.loadMore": "Load earlier entries",
  "company.thread.empty": "No entries in this thread yet.",
  "company.thread.status.active": "Active",
  "company.thread.status.completed": "Completed",
  "company.thread.status.interrupted": "Interrupted",
  "company.thread.run.queued": "Queued",
  "company.thread.run.running": "Board discussion running",
  "company.thread.run.projecting": "Preparing grounded result",
  "company.thread.run.completed": "Run completed",
  "company.thread.run.failed": "Run failed — retryable",
  "company.thread.run.interrupted": "Run interrupted",
  "company.thread.source.open": "Show evidence",
  "company.composer.label": "Send a message",
  "company.composer.placeholder": "Send a goal to the board…",
  "company.composer.send": "Send",
  "company.composer.sending": "Sending…",
  "company.composer.retry": "Retry",
  "company.composer.interrupt": "Interrupt current thread",
  "company.composer.mention.label": "Mention a board role",
