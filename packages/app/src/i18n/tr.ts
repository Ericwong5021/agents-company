...
export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.controlPlane.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.controlPlaneGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Agent Company tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Agent Company'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Agent Company'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Agent Company'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler agent-company.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Agent Company sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Agent Company'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Agent Company ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (agent-company.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Agent Company henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Agent Company Masaüstü",
  ...
  "settings.desktop.wsl.description": "Agent Company sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Agent Company'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Agent Company'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Agent Company'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Agent Company'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Agent Company başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Agent Company'un en son sürümünü kullanıyorsunuz.",
  ...
  "company.pairing.title": "Bu tarayıcıyı eşleştir",
  "company.pairing.description": "Yerel Agent Company sunucunuzdan kısa süreli bir eşleştirme kodu girin.",
  "company.pairing.code.label": "Eşleştirme kodu",
  "company.pairing.label.label": "Tarayıcı adı",
  "company.pairing.submit": "Güvenle bağlan",
  "company.pairing.pending": "Bağlanıyor…",
  "company.pairing.invalid": "Eşleştirme kodu geçersiz veya süresi dolmuş.",
