export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.controlPlane.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.controlPlaneGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Besøg ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i agent-company.json",
  ...
  "dialog.server.description": "Skift hvilken Agent Company-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Agent Company ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Agent Company-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (agent-company.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Agent Company understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Agent Company-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Agent Company",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Agent Company ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Agent Company følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Agent Company er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Agent Company starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Agent Company.",
  ...
  "company.pairing.title": "Par denne browser",
  "company.pairing.description": "Indtast en kortvarig parringskode fra din lokale Agent Company-server.",
  "company.pairing.code.label": "Parringskode",
  "company.pairing.label.label": "Browsernavn",
  "company.pairing.submit": "Forbind sikkert",
  "company.pairing.pending": "Forbinder…",
  "company.pairing.invalid": "Parringskoden er ugyldig eller udløbet.",
}
