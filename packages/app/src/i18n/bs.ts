export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.controlPlane.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.controlPlaneGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Agent Company-u.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Posjeti ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Agent Company-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Agent Company-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u agent-company.json",
  ...
  "dialog.server.description": "Promijeni na koji se Agent Company server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Agent Company-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Agent Company timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (agent-company.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Agent Company još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Agent Company server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Agent Company-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Agent Company izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Agent Company prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Agent Company-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Agent Company pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Agent Company-a.",
  ...
  "company.pairing.title": "Upari ovaj preglednik",
  "company.pairing.description": "Unesi kratkotrajni kod za uparivanje s lokalnog Agent Company servera.",
  "company.pairing.code.label": "Kod za uparivanje",
  "company.pairing.label.label": "Naziv preglednika",
  "company.pairing.submit": "Poveži sigurno",
  "company.pairing.pending": "Povezivanje…",
  "company.pairing.invalid": "Kod za uparivanje nije važeći ili je istekao.",
}
