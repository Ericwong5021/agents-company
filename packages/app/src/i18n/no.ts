...
export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.controlPlane.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.controlPlaneGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Besøk ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i agent-company.json",
  ...
  "dialog.server.description": "Bytt hvilken Agent Company-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Agent Company ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Agent Company-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (agent-company.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Agent Company ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Agent Company inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Agent Company-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Agent Company",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Agent Company ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Agent Company skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Agent Company er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Agent Company starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Agent Company.",
  ...
  "company.pairing.title": "Par denne nettleseren",
  "company.pairing.description": "Skriv inn en kortvarig parkode fra den lokale Agent Company-serveren din.",
  "company.pairing.code.label": "Parkode",
  "company.pairing.label.label": "Nettlesernavn",
  "company.pairing.submit": "Koble til sikkert",
  "company.pairing.pending": "Kobler til…",
  "company.pairing.invalid": "Parkoden er ugyldig eller utløpt.",
