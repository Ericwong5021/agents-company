export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.controlPlane.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.controlPlaneGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Agent Companyが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Agent Companyで{{provider}}モデルを使用します。",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated providerは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.controlPlaneZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.controlPlaneZen.visit.prefix": " ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAgent Companyで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Agent Companyで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "agent-company.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAgent Companyサーバーを切り替えます。",
  ...
  "toast.update.description": "Agent Companyの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAgent Companyチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (agent-company.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Agent CompanyはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Agent Companyには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAgent Companyサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Agent Companyの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのAgent Companyの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Agent Companyがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Agent Companyのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Agent Company の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Agent Company は最新バージョンです。",
  ...
  "company.pairing.title": "このブラウザをペアリング",
  "company.pairing.description": "ローカル Agent Company サーバーの短時間有効なペアリングコードを入力してください。",
  "company.pairing.code.label": "ペアリングコード",
  "company.pairing.label.label": "ブラウザ名",
  "company.pairing.submit": "安全に接続",
  "company.pairing.pending": "接続中…",
  "company.pairing.invalid": "ペアリングコードが無効か期限切れです。",
}
