export const dict = {
  ...
  "dialog.provider.controlPlane.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.controlPlane.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.controlPlaneGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Agent Company",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "يمنحك curated provider الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "قم بزيارة ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Agent Company.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في agent-company.json",
  ...
  "dialog.server.description": "تبديل خادم Agent Company الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Agent Company ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Agent Company",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (agent-company.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Agent Company لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Agent Company نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Agent Company داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Agent Company",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Agent Company على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Agent Company يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Agent Company.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Agent Company",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Agent Company.",
  ...
  "company.pairing.title": "إقران هذا المتصفح",
  "company.pairing.description": "أدخل رمز إقران قصير الأجل من خادم Agent Company المحلي.",
  "company.pairing.code.label": "رمز الإقران",
  "company.pairing.label.label": "اسم المتصفح",
  "company.pairing.submit": "اتصال آمن",
  "company.pairing.pending": "جارٍ الاتصال…",
  "company.pairing.invalid": "رمز الإقران غير صالح أو انتهت صلاحيته.",
}
