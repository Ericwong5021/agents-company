export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.controlPlane.tagline": "Modèles optimisés et fiables",
  "dialog.provider.controlPlaneGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Visitez ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Agent Company.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans agent-company.json",
  ...
  "dialog.server.description": "Changez le serveur Agent Company auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Agent Company ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Agent Company",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (agent-company.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Agent Company ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Agent Company inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Agent Company dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Agent Company",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Agent Company sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Agent Company suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Agent Company.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Agent Company",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Agent Company.",
  ...
  "company.pairing.title": "Associer ce navigateur",
  "company.pairing.description": "Saisissez un code d’association de courte durée depuis votre serveur Agent Company local.",
  "company.pairing.code.label": "Code d’association",
  "company.pairing.label.label": "Nom du navigateur",
  "company.pairing.submit": "Se connecter de façon sécurisée",
  "company.pairing.pending": "Connexion…",
  "company.pairing.invalid": "Le code d’association est invalide ou a expiré.",
}
