export const dict = {
  ...
  "dialog.provider.controlPlane.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.controlPlane.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.controlPlaneGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Agent Company",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Agent Company.",
  ...
  "provider.connect.controlPlaneZen.line1":
    "curated provider daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.controlPlaneZen.visit.prefix": "Odwiedź ",
  "provider.connect.controlPlaneZen.visit.link": "local setup",
  "provider.connect.controlPlaneZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Agent Company.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Agent Company.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w agent-company.json",
  ...
  "dialog.server.description": "Przełącz serwer Agent Company, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Agent Company ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Agent Company",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (agent-company.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Agent Company zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Agent Company",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Agent Company na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Agent Company ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Agent Company.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Agent Company",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Agent Company.",
  ...
  "company.pairing.title": "Sparuj tę przeglądarkę",
  "company.pairing.description": "Wpisz krótkotrwały kod parowania z lokalnego serwera Agent Company.",
  "company.pairing.code.label": "Kod parowania",
  "company.pairing.label.label": "Nazwa przeglądarki",
  "company.pairing.submit": "Połącz bezpiecznie",
  "company.pairing.pending": "Łączenie…",
  "company.pairing.invalid": "Kod parowania jest nieprawidłowy lub wygasł.",
}
