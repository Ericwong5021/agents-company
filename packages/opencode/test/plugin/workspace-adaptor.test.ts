...
const experimental = Flag.AGENTCOMPANY_EXPERIMENTAL_WORKSPACES

Flag.AGENTCOMPANY_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.AGENTCOMPANY_EXPERIMENTAL_WORKSPACES = experimental
})
