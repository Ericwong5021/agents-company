...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.AGENTCOMPANY_TEXT_NGRAM_N,
    Flag.AGENTCOMPANY_TEXT_REPEAT_THRESHOLD,
    Flag.AGENTCOMPANY_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.AGENTCOMPANY_TEXT_WINDOW_TOKENS} tokens).
