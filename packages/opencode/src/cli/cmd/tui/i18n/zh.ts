...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 agent-company 即表示你同意我们的",
  ...
  "tui.tips.share": "运行 {highlight}/share{/highlight} 在 agent-company 上为你的对话生成公开链接",
  ...
  "tui.tips.config_files":
    "创建 {highlight}agentcompany.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/agentcompany/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "agent-company 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.agentcompany/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.agentcompany/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "agent-company 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "agent-company 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.agentcompany/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.agentcompany/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 agent-company 读取敏感文件",
  "tui.tips.run": "用 {highlight}agents run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}agents --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}agents run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}agents serve{/highlight} 以无头模式提供 agent-company API",
  "tui.tips.attach_server": "用 {highlight}agents run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}agents upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}agents auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}agents agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opencode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}agents github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.brand_color_note": "品牌色会自动同步对应的高光、光晕和阴影色",
  "tui.tips.theme_files": "在 {highlight}.agentcompany/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.zen": "搭配 agent-company 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.dialog.exit.title": "退出确认",
  "tui.dialog.exit.message": "确定要退出应用吗？",
  ...
  "tui.dialog.model.login_hint": "提示：先运行 /connect 添加 provider，再切换模型",
  ...
  "tui.dialog.login.flow.title": "agent-company 登录",
  ...
  "tui.shell.route.group-session": "群组会话",
  "tui.shell.route.plugin": "插件",
  "tui.shell.route.org-chart": "组织架构",
  "tui.shell.route.project-management": "项目管理",
  "tui.shell.route.agent-management": "Agent 管理",
  "tui.shell.route.settings": "设置",
  "tui.shell.right.recent": "近期会话",
  "tui.shell.right.members": "成员",
  "tui.shell.right.agents": "Agent 列表",
  "tui.shell.right.settings": "设置菜单",
  "tui.settings.group.appearance": "外观",
  "tui.settings.group.interface": "界面",
  "tui.settings.group.tools": "工具",
  "tui.settings.group.system": "系统",
  "tui.settings.group.danger": "危险操作",
  "tui.org.disband.title": "解散公司",
  "tui.org.disband.menu_description": "删除全部公司数据 —— 不可恢复",
  "tui.org.disband.confirm": "将永久删除所有 agent、线程、会话、任务和工作区文件。登录态和应用设置会保留。确定继续吗？",
  "tui.org.disband.yes": "确定解散 (y)",
  "tui.org.disband.no": "取消 (esc)",
  "tui.org.disband.warning.title": "⚠ 不可恢复 —— 请仔细阅读",
  "tui.org.disband.warning.body": "所有公司数据将被永久删除且无法恢复。按 y 确认执行。",
  "tui.org.disband.warning.confirm": "全部删除 (y)",
  "tui.org.disband.running": "正在解散…",
  ...
  "onboarding.interview.title": "引导访谈",
  "onboarding.interview.preparing": "正在准备您的助手...",
  "onboarding.interview.placeholder.name": "请输入您的名字...",
  "onboarding.interview.placeholder.company": "请输入公司名称...",
  "onboarding.interview.placeholder.assistant": "给您的助手起个名字...",
  "onboarding.interview.placeholder.message": "输入消息...",
  "onboarding.interview.sending": "发送中...",
  "onboarding.scope.title": "选择您的业务范围（可多选）：",
  "onboarding.scope.saas": "SaaS",
  "onboarding.scope.saas.desc": "构建和销售软件产品",
  "onboarding.scope.content": "内容创作",
  "onboarding.scope.content.desc": "内容创作、媒体、教育",
  "onboarding.scope.consulting": "咨询服务",
  "onboarding.scope.consulting.desc": "专业咨询和顾问服务",
  "onboarding.scope.ecommerce": "电子商务",
  "onboarding.scope.ecommerce.desc": "在线零售和市场",
  "onboarding.scope.agency": "代理服务",
  "onboarding.scope.agency.desc": "营销、设计或开发代理",
  "onboarding.scope.custom": "自定义",
  "onboarding.scope.custom.desc": "定义您自己的业务范围",
  "onboarding.scope.selected": "已选择：",
  "onboarding.scope.confirm": "确认 →",
  "onboarding.founding_team.title": "创始团队已组建！",
  "onboarding.founding_team.congratulations": "恭喜！您的团队已就绪。",
  "onboarding.founding_team.enter": "进入公司 →",
  "onboarding.founding_team.loading": "正在加载团队详情...",
  "onboarding.founding_team.assembling": "正在组建您的创始团队...",
  "onboarding.founding_team.wait": "这可能需要一点时间",
  "onboarding.founding_team.searching": "正在为你的公司匹配「{{role}}」……",
  "onboarding.founding_team.matching": "正在匹配 {{role}} ……",
  "onboarding.founding_team.complete_speech": "太好了，{{name}}！你的创始团队组建完成！",
  "onboarding.founding_team.error": "创始团队组建失败，请重试。",
  "onboarding.founding_team.copy_error": "复制错误信息",
  "onboarding.founding_team.ready": "{{assistant}} 和你的创始团队已就绪。",
  "onboarding.provider.required": "请先连接一个提供商并选择模型以继续。",
  "onboarding.provider.retry": "重试 ↻",
  "onboarding.assistant.default_name": "小助理",
  "onboarding.assistant.description": "温暖的向导，帮你搭建公司与团队。",
  "onboarding.profile.title": "完善你的资料",
  "onboarding.profile.next": "下一步 →",
  "onboarding.profile.ask_name": "你好！我是你的引导小助理。先认识一下——我该怎么称呼你？",
  "onboarding.profile.ask_company": "{{name}}，你的公司叫什么名字？",
  "onboarding.profile.ask_assistant": "很高兴认识你，{{name}}！那你想给我起个什么名字呢？",
  "onboarding.profile.ask_scope": "太好了，{{name}}！你想做哪种一人公司？",
  "onboarding.profile.error.name": "请输入有效的名字（1-50 个字符）。",
  "onboarding.profile.error.company": "请输入有效的公司名（1-50 个字符）。",
  "onboarding.profile.error.assistant": "请输入有效的名字（1-30 个字符）。",
  "onboarding.profile.error.assistant_same": "我的名字最好和你的不一样哦。",
  ...
  "onboarding.mission.generating": "{{assistant}} 正在翻阅你的资料……",
  "onboarding.mission.skip": "暂时跳过 →",
  "onboarding.mission.build": "组建团队 →",
  "onboarding.mission.you": "你",
  "onboarding.mission.error": "出了点问题，请重试。",
  "onboarding.mission.error.empty": "请输入你的公司愿景",
  "onboarding.mission.placeholder": "描述你想要创建的公司……",
  "onboarding.achievement.title": "成就解锁：初创团队",
  "onboarding.achievement.desc": "恭喜你，{{name}}！你的创始团队诞生了。",

  // Template selection
  "onboarding.template.title": "选择你的公司形态",
  "onboarding.template.speech": "选一个最接近你想法的组织模板，之后还可以调整。",
  "onboarding.template.starter": "快速启动",
  "onboarding.template.advanced": "进阶配置",
  "onboarding.template.roles": "个角色",
  "onboarding.template.preview": "组织预览",
  "onboarding.template.confirm": "选择此模板 →",
  "onboarding.template.selected": "已选模板",

  // Customize step
  "onboarding.customize.title": "个性化设置",
  "onboarding.customize.ask_name": "你选了「{{template}}」模板！先认识一下——我该怎么称呼你？",
  "onboarding.customize.ask_assistant": "很高兴认识你，{{name}}！那你想给我起个什么名字呢？",

  // Mission opening (local, no LLM)
  "onboarding.mission.opening": "{{name}}，你想用这家「{{scope}}」公司做成什么事？聊聊你的想法。",

  // Workstation
  "tui.workstation.status.idle": "空闲",
  "tui.workstation.status.busy": "忙碌",
  "tui.workstation.status.paused": "暂停",
  "tui.workstation.thread.primary": "[主线程]",
  "tui.workstation.thread.reactive": "[响应线程]",
  "tui.workstation.thread.ambient": "[后台线程]",
  "tui.workstation.department": "部门",
  "tui.workstation.layer": "层级",
  "tui.workstation.tokens": "Token 用量",
  "tui.workstation.working": "工作中...",
  "tui.workstation.no_threads": "暂无活跃线程",
  "tui.workstation.empty": "尚未配置智能体，请从 Agent 管理页面创建。",
  "tui.workstation.refresh": "刷新",
  "tui.workstation.add_agent": "添加 Agent",
  "tui.workstation.create_agent": "创建 Agent",
  "tui.workstation.agents": "智能体",
  "tui.workstation.summary.active": "活跃",
  "tui.workstation.summary.threads": "线程",
  "tui.workstation.summary.tasks": "任务",
  "tui.workstation.summary.tokens": "Token",
  "tui.workstation.summary.observed": "实耗",
  "tui.workstation.summary.approvals": "审批",
  "tui.workstation.presence.busy": "忙碌",
  "tui.workstation.presence.idle": "空闲",
  "tui.workstation.project.blocked": "项目已阻断",
  "tui.workstation.project.running": "项目运行中",
  "tui.workstation.approval.title": "审批队列",
  "tui.workstation.approval.approve": "批准",
  "tui.workstation.approval.reject": "拒绝",
  "tui.workstation.approval.approved": "已批准",
  "tui.workstation.approval.rejected": "已拒绝",
  "tui.workstation.approval.failed": "处理审批失败",
  "tui.workstation.collaboration.title": "协作链",
  "tui.workstation.collaboration.messages": "条消息",
  "tui.workstation.action.start": "启动",
  "tui.workstation.action.stop": "停止",
  "tui.workstation.action.configure": "配置",
  "tui.workstation.action.start_description": "从工作台启动的主线程",
  "tui.workstation.action.start_success": "智能体已启动",
  "tui.workstation.action.start_failed": "启动智能体失败",
  "tui.workstation.action.stop_success": "智能体已停止",
  "tui.workstation.action.stop_failed": "停止智能体失败",
