export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using agent-company, you agree to our ",
  ...
  "tui.tips.brand_color":
    "Use {highlight}/brand-color{/highlight} or {highlight}Ctrl+X C{/highlight} to switch the brand color family",
  "tui.tips.theme":
  ...
  "tui.tips.run": "Use {highlight}agents run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}agents --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}agents run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}agents serve{/highlight} for headless API access to agent-company",
  "tui.tips.attach_server": "Use {highlight}agents run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}agents upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}agents auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}agents agent create{/highlight} for guided agent creation",
  ...
  "tui.tips.debug_config": "Run {highlight}agents debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with agent-company for curated, tested models",
  ...
  "tui.dialog.exit.title": "Exit Confirmation",
  "tui.dialog.exit.message": "Are you sure you want to exit?",
  ...
  "tui.dialog.model.login_hint": "Tip: run /connect to add a provider before switching models",
  ...
  "tui.shell.route.group-session": "Group Session",
  "tui.shell.route.plugin": "Plugin",
  "tui.shell.route.org-chart": "Organization",
  "tui.shell.route.project-management": "Projects",
  "tui.shell.route.agent-management": "Agent Management",
  "tui.shell.route.workstation": "Workstation",
  "tui.shell.route.settings": "Settings",
  "tui.shell.right.recent": "Recent conversations",
  "tui.shell.right.members": "Members",
  "tui.shell.right.agents": "Agents",
  "tui.shell.right.workstation": "Workstation",
  "tui.shell.right.settings": "Settings menu",
  "tui.settings.group.appearance": "Appearance",
  "tui.settings.group.interface": "Interface",
  "tui.settings.group.tools": "Tools",
  "tui.settings.group.system": "System",
  ...
  "onboarding.interview.title": "Onboarding Interview",
  "onboarding.interview.preparing": "Preparing your assistant...",
  "onboarding.interview.placeholder.name": "Type your name...",
  "onboarding.interview.placeholder.company": "Enter company name...",
  "onboarding.interview.placeholder.assistant": "Name your assistant...",
  "onboarding.interview.placeholder.message": "Type your message...",
  "onboarding.interview.sending": "Sending...",
  "onboarding.scope.title": "Select your business scope (multi-select):",
  "onboarding.scope.saas": "SaaS",
  "onboarding.scope.saas.desc": "Build and sell software products",
  "onboarding.scope.content": "Content",
  "onboarding.scope.content.desc": "Content creation, media, education",
  "onboarding.scope.consulting": "Consulting",
  "onboarding.scope.consulting.desc": "Professional consulting and advisory",
  "onboarding.scope.ecommerce": "E-commerce",
  "onboarding.scope.ecommerce.desc": "Online retail and marketplace",
  "onboarding.scope.agency": "Agency",
  "onboarding.scope.agency.desc": "Marketing, design, or dev agency",
  "onboarding.scope.custom": "Custom",
  "onboarding.scope.custom.desc": "Define your own business scope",
  "onboarding.scope.selected": "Selected:",
  "onboarding.scope.confirm": "Confirm →",
  "onboarding.founding_team.title": "Founding Team Assembled!",
  "onboarding.founding_team.congratulations": "Congratulations! Your team is ready.",
  "onboarding.founding_team.enter": "Enter Company →",
  ...
  "onboarding.founding_team.copy_error": "Copy error",
  "onboarding.founding_team.ready": "{{assistant}} and your founding team are ready.",
  "onboarding.provider.required": "Connect a provider and pick a model to continue.",
  "onboarding.provider.retry": "Try Again ↻",
  "onboarding.assistant.default_name": "Helper",
  "onboarding.assistant.description": "A warm guide that helps you set up your company and team.",
  "onboarding.profile.title": "Set Up Your Profile",
  "onboarding.profile.next": "Next →",
  "onboarding.profile.ask_name": "Hi! I'm your setup helper. First — what should I call you?",
  "onboarding.profile.ask_company": "{{name}}, what's your company name?",
  "onboarding.profile.ask_assistant": "Nice to meet you, {{name}}! Now, what would you like to name me?",
  "onboarding.profile.ask_scope": "Great, {{name}}! What kind of one-person company are you building?",
  "onboarding.profile.error.name": "Please enter a valid name (1-50 characters).",
  "onboarding.profile.error.company": "Please enter a valid company name (1-50 characters).",
  "onboarding.profile.error.assistant": "Please enter a valid name (1-30 characters).",
  "onboarding.profile.error.assistant_same": "My name should be different from yours.",
  ...
  "onboarding.mission.generating": "{{assistant}} is reviewing your profile…",
  ...
  "onboarding.mission.error.empty": "Please enter your company vision",
  "onboarding.mission.placeholder": "Describe the company you want to build…",
  "onboarding.achievement.title": "Achievement Unlocked: Founding Team",
  "onboarding.achievement.desc": "Congratulations, {{name}}! Your founding team is born.",

  // Template selection
  "onboarding.template.title": "Choose Your Organization",
  "onboarding.template.speech": "Pick a template that fits your vision — you can adjust it later.",
  "onboarding.template.starter": "Quick Start",
  "onboarding.template.advanced": "Advanced",
  "onboarding.template.roles": "roles",
  "onboarding.template.preview": "Preview",
  "onboarding.template.confirm": "Select Template →",
  "onboarding.template.selected": "Template selected",

  // Customize step
  "onboarding.customize.title": "Personalize",
  "onboarding.customize.ask_name": "You chose the「{{template}}」template! Let's start — what should I call you?",
  "onboarding.customize.ask_assistant": "Nice to meet you, {{name}}! What would you like to name me?",

  // Mission opening (local, no LLM)
  "onboarding.mission.opening": "{{name}}, what do you want to build with this {{scope}} company? Tell me your vision.",

  // Workstation
  "tui.workstation.status.idle": "idle",
  "tui.workstation.status.busy": "busy",
  "tui.workstation.status.paused": "paused",
  "tui.workstation.thread.primary": "[primary]",
  "tui.workstation.thread.reactive": "[reactive]",
  "tui.workstation.thread.ambient": "[ambient]",
  "tui.workstation.department": "Department",
  "tui.workstation.layer": "Layer",
  "tui.workstation.tokens": "Tokens",
  "tui.workstation.working": "Working...",
  "tui.workstation.no_threads": "No active threads",
  "tui.workstation.empty": "No agents configured yet. Create one from the Agents page.",
  "tui.workstation.refresh": "Refresh",
  "tui.workstation.add_agent": "Add Agent",
  "tui.workstation.create_agent": "Create Agent",
  "tui.workstation.agents": "Agents",
  "tui.workstation.summary.active": "Active",
  "tui.workstation.summary.threads": "Threads",
  "tui.workstation.summary.tasks": "Tasks",
  "tui.workstation.summary.tokens": "Tokens",
  "tui.workstation.summary.observed": "Observed",
  "tui.workstation.summary.approvals": "Approvals",
  "tui.workstation.presence.busy": "Busy",
  "tui.workstation.presence.idle": "Idle",
  "tui.workstation.project.blocked": "Project blocked",
  "tui.workstation.project.running": "Project running",
  "tui.workstation.approval.title": "Approval queue",
  "tui.workstation.approval.approve": "Approve",
  "tui.workstation.approval.reject": "Reject",
  "tui.workstation.approval.approved": "Approval granted",
  "tui.workstation.approval.rejected": "Approval rejected",
  "tui.workstation.approval.failed": "Failed to resolve approval",
  "tui.workstation.collaboration.title": "Collaboration chain",
  "tui.workstation.collaboration.messages": "messages",
  "tui.workstation.action.start": "Start",
  "tui.workstation.action.stop": "Stop",
  "tui.workstation.action.configure": "Configure",
  "tui.workstation.action.start_description": "Primary thread started from workstation",
  "tui.workstation.action.start_success": "Agent started",
  "tui.workstation.action.start_failed": "Failed to start agent",
  "tui.workstation.action.stop_success": "Agent stopped",
  "tui.workstation.action.stop_failed": "Failed to stop agent",
}
