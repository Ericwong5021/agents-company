...
ALTER TABLE company_capability_need RENAME TO company_capability_need_knowledge_legacy;
--> statement-breakpoint
ALTER TABLE company_team_selection RENAME TO company_team_selection_knowledge_legacy;
--> statement-breakpoint
ALTER TABLE company_agent_performance RENAME TO company_agent_performance_knowledge_legacy;
--> statement-breakpoint
ALTER TABLE company_project_assignment RENAME TO company_project_assignment_knowledge_legacy;
--> statement-breakpoint
CREATE TABLE company_capability_need (
  ...
  CONSTRAINT company_capability_need_work_type_check CHECK (work_type IN ('coding', 'decision', 'research', 'writing', 'design', 'analysis', 'knowledge_reading')),
...
--> statement-breakpoint
INSERT INTO company_project_assignment SELECT * FROM company_project_assignment_knowledge_legacy;
--> statement-breakpoint
DROP TABLE company_agent_performance_knowledge_legacy;
--> statement-breakpoint
DROP TABLE company_project_assignment_knowledge_legacy;
--> statement-breakpoint
DROP TABLE company_team_selection_knowledge_legacy;
--> statement-breakpoint
DROP TABLE company_capability_need_knowledge_legacy;
--> statement-breakpoint
