...
describe("skill", () => {
  it.live("discovers skills from .agentcompany/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".agentcompany", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".agentcompany", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".agentcompany", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .agentcompany/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".agentcompany", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".agentcompany", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".agentcompany", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".agentcompany", "skill", "agent-skill", "SKILL.md"),
                `---
name: control-plane-skill
description: A skill in the .agentcompany/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".agentcompany", "skills", "agent-skill", "SKILL.md"),
                `---
name: control-plane-skill
description: A skill in the .agentcompany/skills directory.
---
