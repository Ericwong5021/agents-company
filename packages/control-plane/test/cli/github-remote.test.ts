...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/control-plane.git")).toEqual({ owner: "sst", repo: "control-plane" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/control-plane")).toEqual({ owner: "sst", repo: "control-plane" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/control-plane.git")).toEqual({ owner: "sst", repo: "control-plane" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/control-plane")).toEqual({ owner: "sst", repo: "control-plane" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/control-plane.git")).toEqual({ owner: "sst", repo: "control-plane" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/control-plane")).toEqual({ owner: "sst", repo: "control-plane" })
})
