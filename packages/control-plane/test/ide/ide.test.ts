...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CONTROL_PLANE_CALLER", () => {
    process.env["CONTROL_PLANE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CONTROL_PLANE_CALLER", () => {
    process.env["CONTROL_PLANE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CONTROL_PLANE_CALLER", () => {
    process.env["CONTROL_PLANE_CALLER"] = "unknown"
