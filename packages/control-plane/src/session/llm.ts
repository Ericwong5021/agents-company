 ...
 *   (configured per-provider via `chunkTimeout` in agentcompany.json). This
...
export class Service extends Context.Service<Service, Interface>()("@control-plane/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via control-plane's tool system
