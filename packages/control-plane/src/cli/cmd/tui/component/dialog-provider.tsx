...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@agents-company/sdk/v2"
      ...
      map((provider) => {
        ...
        return {
          ...
          description: {
            ...
            "control-plane-go": "Low cost subscription for everyone",
          }[provider.id],
...
export async function runCustomProviderWizard(opts: {
  ...
  const nameRaw = await step(2, 6, "Display name", "e.g. Agent Company Router", providerID)
          ...
          "control-plane": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Agent Company gives you access to top coding models with a single API key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://control-plane.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "control-plane-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Agent Company subscription provides reliable access to popular open coding models with generous usage
                limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://control-plane.ai/zen</span> and enable Agent Company
              </text>
            </box>
          ),
