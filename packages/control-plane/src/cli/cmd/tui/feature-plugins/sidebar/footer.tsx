...
function View(props: { api: TuiPluginApi }) {
  ...
  const has = createMemo(() =>
    props.api.state.provider.some(
      (item) => item.id !== "control-plane" || Object.values(item.models).some((model) => model.cost?.input !== 0),
    ),
  )
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>
              Add your own provider to start using Agent Company with your preferred models.
            </text>
