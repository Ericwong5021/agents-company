...
import { DialogBrandColor } from "@tui/component/dialog-brand-color"
...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "session") {
      ...
      renderer.setTerminalTitle(`agent-company | ${title}`)
      return
    }
  ...
  command.register(() => [
    ...
    ...(sync.data.console_state.switchableOrgCount > 1
      ...
      : []),
    {
      title: t("tui.command.controlPlane.status.title"),
      keybind: "status_view",
      value: "control-plane.status",
      slash: {
        name: "status",
      },
      onSelect: () => {
    ...
    {
      title: t("tui.command.brand_color.switch.title"),
      value: "brand_color.switch",
      slash: {
        name: "brand-color",
      },
      onSelect: () => {
        dialog.replace(() => <DialogBrandColor />)
      },
      category: "system",
    },
    {
