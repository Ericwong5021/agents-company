...
export const dict = {
  ...
  "tui.home.agreement.prefix": "agent-company をご利用いただくことで、",
  ...
  "tui.tips.share": "{highlight}/share{/highlight} を実行すると agent-company に会話の公開リンクを作成します",
  ...
  "tui.tips.formatter": "agent-company は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.run": "{highlight}agents run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}agents --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}agents run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}agents serve{/highlight} を実行するとヘッドレスで agent-company API にアクセスできます",
  "tui.tips.attach_server": "{highlight}agents run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}agents upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}agents auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}agents agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/control-plane{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}agents github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.debug_config": "{highlight}agents debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.docker":
    "{highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} でコンテナ版を実行できます",
  "tui.tips.zen": "agent-company と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.command.controlPlane.status.title": "ステータスを表示",
  ...
  "tui.toast.update_available.success": "agent-company v{{version}} に更新しました。アプリケーションを再起動してください。",
  ...
  "cli.providers.mimo_free.usage_hint":
    "ログイン不要 — そのまま agents を実行できます。有料/上位モデルを利用する場合は MiMo ブラウザログインを選択してください。",
  ...
  "trust.capabilities": "agent-company はここでファイルの読み取り、編集、実行が可能になります。",
  ...
  "tui.shell.nav.home": "ホーム",
  "tui.shell.nav.recent": "最近",
  "tui.shell.nav.org-chart": "組織図",
  "tui.shell.nav.projects": "プロジェクト",
  "tui.shell.nav.agents": "エージェント",
  "tui.shell.nav.settings": "設定",
  "tui.shell.back": "戻る",
  "tui.shell.route.home": "ホーム",
  "tui.shell.route.session": "セッション",
  "tui.shell.route.group-session": "グループセッション",
  "tui.shell.route.plugin": "プラグイン",
  "tui.shell.route.org-chart": "組織図",
  "tui.shell.route.project-management": "プロジェクト",
  "tui.shell.route.agent-management": "エージェント管理",
  "tui.shell.route.settings": "設定",
  "tui.shell.right.recent": "最近の会話",
  "tui.shell.right.members": "メンバー",
  "tui.shell.right.agents": "エージェント一覧",
  "tui.shell.right.settings": "設定メニュー",
  "tui.settings.group.appearance": "外観",
  "tui.settings.group.interface": "インターフェース",
  "tui.settings.group.tools": "ツール",
  "tui.settings.group.system": "システム",
  "tui.shell.placeholder.projects": "プロジェクト管理は近日公開",
