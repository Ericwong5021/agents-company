...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar agent-company, aceptas nuestros ",
  ...
  "tui.home.board_chat.title": "Iniciar un proyecto de empresa",
  "tui.home.board_chat.placeholder": "Describe el resultado que quieres lograr...",
  "tui.home.board_chat.hint": "Enter para iniciar · / para comandos",
  "tui.home.board_chat.sending": "iniciando...",
  ...
  "tui.tips.share":
    "Ejecuta {highlight}/share{/highlight} para crear un enlace público a tu conversación en agent-company",
  ...
  "tui.tips.config_files":
    "Crea {highlight}agentcompany.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/agentcompany/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "agent-company gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.agentcompany/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.agentcompany/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "agent-company formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "agent-company usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.agentcompany/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.agentcompany/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a agent-company leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}agents run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}agents --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}agents run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}agents serve{/highlight} para acceso headless a la API de agent-company",
  "tui.tips.attach_server":
    "Usa {highlight}agents run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}agents upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}agents auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}agents agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/control-plane{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install":
    "Ejecuta {highlight}agents github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.agentcompany/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}agents debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Ejecuta {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} para uso en contenedor",
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con agent-company para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.command.controlPlane.status.title": "Ver estado",
  ...
  "tui.dialog.exit.title": "Confirmar salida",
  "tui.dialog.exit.message": "¿Estás seguro de que quieres salir?",
  ...
  "tui.toast.update_available.success": "Se actualizó a agent-company v{{version}}. Por favor reinicie la aplicación.",
  ...
  "trust.capabilities": "agent-company podrá leer, editar y ejecutar archivos aquí.",
  ...
  "tui.shell.nav.home": "Inicio",
  "tui.shell.nav.recent": "Reciente",
  "tui.shell.nav.org-chart": "Organización",
  "tui.shell.nav.projects": "Proyectos",
  "tui.shell.nav.agents": "Agentes",
  "tui.shell.nav.settings": "Ajustes",
  "tui.shell.back": "Atrás",
  "tui.shell.route.home": "Inicio",
  "tui.shell.route.session": "Sesión",
  "tui.shell.route.group-session": "Sesión grupal",
  "tui.shell.route.plugin": "Plugin",
  "tui.shell.route.org-chart": "Organización",
  "tui.shell.route.project-management": "Proyectos",
  "tui.shell.route.agent-management": "Gestión de agentes",
  "tui.shell.route.settings": "Ajustes",
  "tui.shell.right.recent": "Conversaciones recientes",
  "tui.shell.right.members": "Miembros",
  "tui.shell.right.agents": "Lista de agentes",
  "tui.shell.right.settings": "Menú de ajustes",
  "tui.settings.group.appearance": "Apariencia",
  "tui.settings.group.interface": "Interfaz",
  "tui.settings.group.tools": "Herramientas",
  "tui.settings.group.system": "Sistema",
  "tui.shell.placeholder.projects": "Gestión de proyectos próximamente",
