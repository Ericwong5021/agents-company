export const dict: Record<string, string> = {
  ...
  "tui.home.board_chat.title": "Send a goal to the board",
  "tui.home.board_chat.subtitle":
    "The board discusses your goal and projects conclusions and risks back to the main channel; project approval comes later.",
  ...
  "tui.company.channel.back": "Back",
  "tui.company.channel.empty": "No messages in this channel yet.",
  "tui.company.channel.loading": "Loading messages...",
  "tui.company.channel.thread": "Thread",
  "tui.company.channel.interrupt": "Interrupt",
  "tui.company.channel.close": "Close",
  "tui.company.channel.sending": "Sending to board...",
  "tui.company.channel.placeholder": "Type a message...",
  "tui.company.channel.thread_load_failed": "Failed to load thread",
  "tui.company.channel.interrupt_failed": "Interrupt failed",
  ...
  "tui.tips.github_trigger": "Use {highlight}/control-plane{/highlight} in GitHub issues/PRs to trigger AI actions",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} for containerized use",
  ...
  "tui.command.controlPlane.status.title": "View status",
  ...
  "tui.shell.route.company-channel": "Company Channel",
  ...
  // Company entry
  "company.setup.required.title": "Company setup required",
  "company.setup.required.body": "Complete company setup in Agent Company Desktop or the browser, then restart this terminal.",
  "company.setup.dataDirectory": "Data directory: {{path}}",
  "company.repositoryMismatch.title": "This terminal is outside the company repository",
  "company.repositoryMismatch.body": "Restart Agent Company from the repository bound to this company.",
  "company.repositoryMismatch.command": "cd \"{{path}}\" && agents",
  "company.connection.title": "Unable to connect to the local Control Plane",
  "company.connection.body": "Check that Agent Company is running, then retry this request.",
  "company.connection.retry": "Press R to retry",
