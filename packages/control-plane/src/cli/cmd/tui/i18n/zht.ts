...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 agent-company 即表示你同意我們的",
  ...
  "tui.tips.share": "執行 {highlight}/share{/highlight} 在 agent-company 上為你的對話產生公開連結",
  ...
  "tui.tips.config_files":
    "建立 {highlight}agentcompany.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/agentcompany/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "agent-company 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.agentcompany/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.agentcompany/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "agent-company 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "agent-company 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.agentcompany/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.agentcompany/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 agent-company 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}agents run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}agents --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}agents run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}agents serve{/highlight} 以無介面模式提供 agent-company API",
  "tui.tips.attach_server": "用 {highlight}agents run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}agents upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}agents auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}agents agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/control-plane{/highlight} 觸發 AI 操作",
  "tui.tips.github_install": "執行 {highlight}agents github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.brand_color_note": "品牌色會自動同步對應的高光、光暈與陰影色",
  "tui.tips.theme_files": "在 {highlight}.agentcompany/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.docker": "執行 {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} 使用容器化版本",
  "tui.tips.zen": "搭配 agent-company 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.command.controlPlane.status.title": "檢視狀態",
  ...
  "tui.dialog.login.flow.title": "agent-company 登入",
  ...
  "tui.shell.route.group-session": "群組會話",
  "tui.shell.route.plugin": "外掛",
  "tui.shell.route.org-chart": "組織架構",
  "tui.shell.route.project-management": "專案管理",
  "tui.shell.route.agent-management": "Agent 管理",
  "tui.shell.route.settings": "設定",
  "tui.shell.right.recent": "近期會話",
  "tui.shell.right.members": "成員",
  "tui.shell.right.agents": "Agent 列表",
  "tui.shell.right.settings": "設定選單",
  "tui.settings.group.appearance": "外觀",
  "tui.settings.group.interface": "介面",
  ...
  "company.setup.required.body": "請先在 Agent Company Desktop 或瀏覽器中完成公司初始化，然後重新啟動此終端。",
  "company.setup.dataDirectory": "資料目錄：{{path}}",
  "company.repositoryMismatch.title": "目前終端不在公司綁定倉庫內",
  "company.repositoryMismatch.body": "請從此公司綁定的主倉庫重新啟動 Agent Company。",
  "company.repositoryMismatch.command": "cd \"{{path}}\" && agents",
  "company.connection.title": "無法連線本機 Control Plane",
  "company.connection.body": "請確認 Agent Company 正在執行，然後重試此請求。",
  "company.connection.retry": "按 R 重試",
