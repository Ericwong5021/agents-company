...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant agent-company, vous acceptez nos ",
  ...
  "tui.tips.share":
    "Exécutez {highlight}/share{/highlight} pour créer un lien public vers votre conversation sur agent-company",
  ...
  "tui.tips.config_files":
    "Créez {highlight}agentcompany.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/agentcompany/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "agent-company gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.agentcompany/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.agentcompany/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "agent-company formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "agent-company utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.agentcompany/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.agentcompany/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.github_trigger":
    "Utilisez {highlight}/control-plane{/highlight} dans les issues/PR GitHub pour déclencher des actions IA",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.agentcompany/themes/{/highlight}",
  ...
  "tui.tips.docker":
    "Exécutez {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} pour une utilisation conteneurisée",
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec agent-company pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.command.controlPlane.status.title": "Voir l'état",
  ...
  "tui.toast.update_available.success": "Mis à jour vers agent-company v{{version}}. Veuillez redémarrer l'application.",
  ...
  "trust.capabilities": "agent-company pourra lire, modifier et exécuter des fichiers ici.",
  ...
  "tui.shell.nav.home": "Accueil",
  "tui.shell.nav.recent": "Récent",
  "tui.shell.nav.org-chart": "Organisation",
  "tui.shell.nav.projects": "Projets",
  "tui.shell.nav.agents": "Agents",
  "tui.shell.nav.settings": "Réglages",
  "tui.shell.back": "Retour",
  "tui.shell.route.home": "Accueil",
  "tui.shell.route.session": "Session",
  "tui.shell.route.group-session": "Session de groupe",
  "tui.shell.route.plugin": "Plugin",
  "tui.shell.route.org-chart": "Organisation",
  "tui.shell.route.project-management": "Projets",
  "tui.shell.route.agent-management": "Gestion des agents",
  "tui.shell.route.settings": "Réglages",
  "tui.shell.right.recent": "Conversations récentes",
  "tui.shell.right.members": "Membres",
  "tui.shell.right.agents": "Liste des agents",
  "tui.shell.right.settings": "Menu des réglages",
  "tui.settings.group.appearance": "Apparence",
  "tui.settings.group.interface": "Interface",
  "tui.settings.group.tools": "Outils",
  "tui.settings.group.system": "Système",
  "tui.shell.placeholder.projects": "Gestion de projets bientôt disponible",
