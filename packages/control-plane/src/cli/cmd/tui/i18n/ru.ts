...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя agent-company, вы соглашаетесь с нашими ",
  ...
  "tui.home.board_chat.title": "Запустить проект компании",
  "tui.home.board_chat.placeholder": "Опишите желаемый результат...",
  "tui.home.board_chat.hint": "Enter для запуска · / для команд",
  "tui.home.board_chat.sending": "запуск...",
  ...
  "tui.tips.share":
    "Выполните {highlight}/share{/highlight}, чтобы получить публичную ссылку на диалог на agent-company",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}agentcompany.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/agentcompany/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "agent-company автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.agentcompany/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.agentcompany/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "agent-company автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "agent-company использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.agentcompany/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.agentcompany/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.github_trigger":
    "Используйте {highlight}/control-plane{/highlight} в issue/PR на GitHub, чтобы запускать AI-действия",
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.agentcompany/themes/{/highlight}",
  ...
  "tui.tips.docker":
    "Выполните {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} для контейнерного запуска",
  "tui.tips.zen":
    "Используйте {highlight}/connect{/highlight} с agent-company для подобранных и протестированных моделей",
  "tui.tips.agents_md":
  ...
  "tui.command.controlPlane.status.title": "Посмотреть статус",
  ...
  "tui.dialog.exit.title": "Подтверждение выхода",
  "tui.dialog.exit.message": "Вы уверены, что хотите выйти?",
  ...
  "tui.toast.update_available.success": "Обновлено до agent-company v{{version}}. Пожалуйста, перезапустите приложение.",
  ...
  "trust.capabilities": "agent-company сможет читать, редактировать и выполнять файлы здесь.",
  ...
  "tui.shell.nav.home": "Главная",
  "tui.shell.nav.recent": "Недавние",
  "tui.shell.nav.org-chart": "Организация",
  "tui.shell.nav.projects": "Проекты",
  "tui.shell.nav.agents": "Агенты",
  "tui.shell.nav.settings": "Настройки",
  "tui.shell.back": "Назад",
  "tui.shell.route.home": "Главная",
  "tui.shell.route.session": "Сессия",
  "tui.shell.route.group-session": "Групповая сессия",
  "tui.shell.route.plugin": "Плагин",
  "tui.shell.route.org-chart": "Организация",
  "tui.shell.route.project-management": "Проекты",
  "tui.shell.route.agent-management": "Управление агентами",
  "tui.shell.route.settings": "Настройки",
  "tui.shell.right.recent": "Недавние диалоги",
  "tui.shell.right.members": "Участники",
  "tui.shell.right.agents": "Список агентов",
  "tui.shell.right.settings": "Меню настроек",
  "tui.settings.group.appearance": "Внешний вид",
  "tui.settings.group.interface": "Интерфейс",
  "tui.settings.group.tools": "Инструменты",
  "tui.settings.group.system": "Система",
  "tui.shell.placeholder.projects": "Управление проектами скоро",
