...
export const dict = {
  ...
  // 公司项目入口
  "tui.home.board_chat.title": "向董事会发送目标",
  "tui.home.board_chat.subtitle": "董事会将讨论你的目标，形成结论与风险后投影回主会话；立项与开发批准留待后续。",
  "tui.home.board_chat.placeholder": "描述你想完成的结果...",
  "tui.home.board_chat.hint": "Enter 发送至董事会 · / 唤起命令",
  ...
  "tui.company.channel.back": "返回",
  "tui.company.channel.empty": "该频道暂无消息。",
  "tui.company.channel.loading": "正在加载消息…",
  "tui.company.channel.thread": "Thread",
  "tui.company.channel.interrupt": "中断",
  "tui.company.channel.close": "关闭",
  "tui.company.channel.sending": "正在发送至董事会…",
  "tui.company.channel.placeholder": "输入消息…",
  "tui.company.channel.thread_load_failed": "加载 Thread 失败",
  "tui.company.channel.interrupt_failed": "中断失败",
  ...
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/control-plane{/highlight} 触发 AI 操作",
  ...
  "tui.tips.docker": "运行 {highlight}docker run -it --rm ghcr.io/anomalyco/control-plane{/highlight} 使用容器化版本",
  ...
  "tui.command.controlPlane.status.title": "查看状态",
  ...
  "tui.shell.route.company-channel": "公司频道",
  ...
  // Company entry
  "company.setup.required.title": "需要先完成公司初始化",
  "company.setup.required.body": "请先在 Agent Company Desktop 或浏览器中完成公司初始化，然后重新启动此终端。",
  "company.setup.dataDirectory": "数据目录：{{path}}",
  "company.repositoryMismatch.title": "当前终端不在公司绑定仓库内",
  "company.repositoryMismatch.body": "请从此公司绑定的主仓库重新启动 Agent Company。",
  "company.repositoryMismatch.command": "cd \"{{path}}\" && agents",
  "company.connection.title": "无法连接本地 Control Plane",
  "company.connection.body": "请确认 Agent Company 正在运行，然后重试此请求。",
  "company.connection.retry": "按 R 重试",
