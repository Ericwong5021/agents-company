import type * as SDK from "@agents-company/sdk/v2"
...
const disabled = process.env["AGENTCOMPANY_DISABLE_SHARE"] === "true" || process.env["AGENTCOMPANY_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@control-plane/ShareNext") {}
