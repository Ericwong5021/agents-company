...
export class Service extends Context.Service<Service, Interface>()("@control-plane/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                question: "allow",
                external_directory: {
                  [path.join(Global.Path.data, "company", "plans", "*")]: "allow",
                },
                edit: {
                  "*": "deny",
                  [path.relative(Instance.worktree, path.join(Global.Path.data, "company", "plans", "*.md"))]: "allow",
                },
              }),
              user,
            ),
