...
export class Service extends Context.Service<Service, Interface>()("@control-plane/Team") {}
...
export const layer: Layer.Layer<Service, never, Bus.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const resolveTeamDir = (teamID: string) => Effect.succeed(path.join(Global.Path.data, "company", "teams", teamID))
