...
import { CompanyLearningRoutes } from "./company-learning"
import { GroupSessionRoutes } from "./group-session"
import { ThreadRoutes } from "./thread"
import { WorkstationRoutes } from "./workstation"
import { AgentLifecycleRoutes } from "./agent-lifecycle"
import { AgentRunRoutes } from "./agent-run"
...
export const InstanceRoutes = (upgrade: UpgradeWebSocket): Hono => {
  ...
  if (Flag.AGENTCOMPANY_EXPERIMENTAL_HTTPAPI) {
  ...
  return app
    ...
    .route("/company-learning", CompanyLearningRoutes())
    .route("/group-session", GroupSessionRoutes())
    .route("/thread", ThreadRoutes())
    .route("/", AgentLifecycleRoutes())
    .route("/workstation", WorkstationRoutes())
    .route("/org", OrgRoutes())
    .route("/rollout", RolloutRoutes())
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current Control Plane instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the Control Plane instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the Control Plane system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the Control Plane system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the Control Plane system.",
