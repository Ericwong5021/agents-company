...
import { DecisionRecordTable, DecisionDispatchOutboxTable } from "@/founder-os/decision-ledger.sql"
import { FounderGreenReadinessTable } from "./founder-delegation.sql"
