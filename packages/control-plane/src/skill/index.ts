...
const EXTERNAL_DIRS = [".claude", ".agents", ".codex", ".control-plane"]
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.AGENTCOMPANY_DISABLE_EXTERNAL_SKILLS) {
    const externalDirs = EXTERNAL_DIRS.filter((dir) => {
      ...
      if (dir === ".control-plane" && Flag.AGENTCOMPANY_DISABLE_CONTROL_PLANE_SKILLS) return false
      return true
    })
...
export class Service extends Context.Service<Service, Interface>()("@control-plane/Skill") {}
