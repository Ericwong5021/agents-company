    ...
    subtasks: {
      ...
      items: {
        ...
        properties: {
          ...
          workType: {
            type: "string",
            enum: ["coding", "decision", "research", "writing", "design", "analysis", "knowledge_reading"],
          },
          role: { type: "string" },
...
function buildDecomposePrompt(goal: string, context?: string): string {
  ...
  parts.push(
    ...
    "- workType: One of coding, decision, research, writing, design, analysis, knowledge_reading",
