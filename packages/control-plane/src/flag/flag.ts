...
const AGENTCOMPANY_DISABLE_CLAUDE_CODE_SKILLS =
  AGENTCOMPANY_DISABLE_EXTERNAL_SKILLS || AGENTCOMPANY_DISABLE_CLAUDE_CODE || truthy("AGENTCOMPANY_DISABLE_CLAUDE_CODE_SKILLS")
...
export const Flag = {
  ...
  AGENTCOMPANY_DISABLE_CODEX_SKILLS: AGENTCOMPANY_DISABLE_EXTERNAL_SKILLS || truthy("AGENTCOMPANY_DISABLE_CODEX_SKILLS"),
  AGENTCOMPANY_DISABLE_CONTROL_PLANE_SKILLS: AGENTCOMPANY_DISABLE_EXTERNAL_SKILLS || truthy("AGENTCOMPANY_DISABLE_CONTROL_PLANE_SKILLS"),
  ...
  AGENTCOMPANY_EXPERIMENTAL_ICON_DISCOVERY: AGENTCOMPANY_EXPERIMENTAL || truthy("AGENTCOMPANY_EXPERIMENTAL_ICON_DISCOVERY"),
  ...
  AGENTCOMPANY_ENABLE_EXA: truthy("AGENTCOMPANY_ENABLE_EXA") || AGENTCOMPANY_EXPERIMENTAL || truthy("AGENTCOMPANY_EXPERIMENTAL_EXA"),
