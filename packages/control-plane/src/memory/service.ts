...
export class Service extends Context.Service<Service, Interface>()("@control-plane/Memory") {}
...
export const layer: Layer.Layer<Service, never, Config.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const search = Effect.fn("Memory.search")(function* (input: {
      ...
      // See packages/control-plane/src/memory/fts-query.ts for the rationale.
